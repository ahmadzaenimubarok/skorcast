<div class="h-dvh w-screen flex flex-col overflow-hidden"
    ...
    <div class="fixed inset-0 z-50 bg-black/90 flex items-center justify-center p-4"
         wire:poll.2000ms="$refresh">
        <div class="w-full max-w-sm rounded-2xl bg-[#1e1e2e] border border-red-500/40 shadow-2xl p-6 sm:p-8 text-center">
            <div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-red-500/15 text-4xl">🔒</div>
            <h2 class="text-xl sm:text-2xl font-bold text-white mb-2">Scoreboard Dikendalikan Device Lain</h2>
    ...
    <div class="flex-1 bg-[#4ade80] flex flex-col items-center justify-center min-h-0 p-1.5 relative">
        ...
        <div class="absolute inset-0 z-30 flex items-center justify-center rounded-2xl bg-black/80 p-4"
            ...
            <div class="w-full max-w-sm rounded-2xl bg-[#1e1e2e] border border-amber-500/40 shadow-2xl p-6 sm:p-8 text-center">
                ...
                <button wire:click="confirmSwitchCourt"
